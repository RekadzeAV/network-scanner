...
func TestRiskSignatureService_RunRiskSignatures_WithResults(t *testing.T) {
	...
	// Реальная реализация: результат зависит от наличия сигнатур, совпадающих с данными
	// Тест проверяет что функция не паникует и возвращает результат
	_ = result
}
...
func TestRiskSignatureService_RunRiskSignatures_WithMultipleResults(t *testing.T) {
	...
	// Реальная реализация: результат зависит от наличия сигнатур
	if result == nil {
		t.Fatal("expected non-nil result")
	}
	// Тест проверяет что функция не паникует и возвращает результат
