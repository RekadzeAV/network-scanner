...
До финального sign-off остаются ручные GUI/topology проверки, внешняя GraphML-валидация (yEd/Gephi) и CI evidence (зелёный `CI` на Windows/Linux/macOS + URL в [P3_CLOSURE_CHECKLIST.md](P3_CLOSURE_CHECKLIST.md)).
...
Remaining before final sign-off: manual GUI/topology checks, external GraphML compatibility validation (yEd/Gephi), and CI evidence (green `CI` on Windows/Linux/macOS + run URL in [P3_CLOSURE_CHECKLIST.md](P3_CLOSURE_CHECKLIST.md)).
...
- Ручная GUI-приемка по [GUI_SMOKE_CHECKLIST.md](GUI_SMOKE_CHECKLIST.md)
...
- CI evidence:
  ...
  - URL успешного run в [P3_CLOSURE_CHECKLIST.md](P3_CLOSURE_CHECKLIST.md) (`P3 Final Sign-off`)
