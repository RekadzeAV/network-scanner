...
| F8 | *Требует подтверждения пользователя:* коммит рабочего набора в main, пуш в origin/main, удаление сломанных refs (`~gvfYSKY.tmp` и др.) | — | 🟡 refs удалены (2026-09-15); коммит/пуш — ожидает подтверждения |
